          ...
          <>
            <section className="space-y-3">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-500 font-mono">1.</span>{t("Общие положения")}</h2>
              <p>
              ...
              <p>
                Политика определяет порядок обработки персональных данных пользователей платформы «Донор-Алерт» (далее – Платформа, Сайт) и меры по обеспечению безопасности персональных данных, принимаемые <strong>{t("Оператором")}</strong>.
              </p>
              <p>{t("В соответствии с требованиями")}<strong>Указа Президента Республики Беларусь от 1 февраля 2010 г. № 60</strong>, базы данных Платформы, содержащие персональные данные граждан Республики Беларусь, физически размещены и обрабатываются на серверах, расположенных на территории Республики Беларусь.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-500 font-mono">2.</span>{t("Используемые термины")}</h2>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>{t("Оператор")}</strong> – государственный орган, юридическое лицо Республики Беларусь, физическое лицо, в том числе индивидуальный предприниматель, самостоятельно или совместно с другими лицами организующие и (или) осуществляющие обработку персональных данных.</li>
                <li><strong>{t("Субъект персональных данных")}</strong> – физическое лицо, в отношении которого осуществляется обработка персональных данных (в рамках Платформы – Пользователь, Донор).</li>
                <li><strong>{t("Уполномоченное лицо")}</strong> – государственный орган, юридическое лицо Республики Беларусь, физическое лицо, которое в соответствии с законодательством либо договором осуществляет обработку персональных данных от имени Оператора (например, медицинские учреждения / центры крови Республики Беларусь).</li>
                <li><strong>{t("Персональные данные")}</strong> – любая информация, относящаяся к идентифицированному физическому лицу или физическому лицу, которое может быть идентифицировано.</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-500 font-mono">3.</span>{t("Цели обработки персональных данных")}</h2>
              <p>{t("Оператор обрабатывает персональные данные в следующих целях:")}</p>
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>{t("Координация взаимодействия пользователей с государственными центрами трансфузиологии (центрами крови) Республики Беларусь;")}</li>
                <li>{t("Предоставление пользователю доступа к личному кабинету донора, ведение электронной карты донора и истории донаций;")}</li>
                <li>{t("Информирование о новостях и мероприятиях в сфере донорства в Республике Беларусь.")}</li>
              </ul>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-500 font-mono">4.</span>{t("Перечень обрабатываемых данных")}</h2>
              <p>{t("В рамках Платформы обрабатываются следующие персональные данные:")}</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>{t("Фамилия, Имя, Отчество (при наличии);")}</li>
                <li>{t("Дата рождения и пол;")}</li>
                <li>Контактный номер телефона и адрес электронной почты (E-mail);</li>
                <li>{t("Медицинские сведения: группа крови, резус-фактор, наличие временных или постоянных медицинских противопоказаний (медотводов), история донаций.")}</li>
              </ul>
            </section>

            <section className="space-y-3 bg-red-50/50 p-5 rounded-2xl border border-red-100">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-650 text-red-600 font-mono">5.</span>{t("Права субъекта персональных данных и механизм их реализации")}</h2>
              <p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-xs">
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center gap-1.5">
                    <CheckCircle className="w-4 h-4 text-emerald-500" />{t("Право на отзыв согласия")}</h4>
                  <p className="text-slate-500">{t("Вы имеете право в любое время без объяснения причин отозвать свое согласие на обработку данных. Отзыв осуществляется в той же форме, в которой согласие было дано, либо путем направления заявления.")}</p>
                </div>

                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center gap-1.5">
                    <CheckCircle className="w-4 h-4 text-emerald-500" />{t("Право на получение информации")}</h4>
                  <p className="text-slate-500">{t("Вы вправе запросить сведения об обработке Ваших персональных данных и получить их в течение")}<strong>5 рабочих дней</strong>{t("бесплатно.")}</p>
                </div>

                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center gap-1.5">
                    <CheckCircle className="w-4 h-4 text-emerald-500" />{t("Право на изменение данных")}</h4>
                  <p className="text-slate-500">{t("В случае неточности или неактуальности данных, Оператор обязан внести изменения в течение")}<strong>15 календарных дней</strong>{t("после получения требования.")}</p>
                </div>

                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center gap-1.5">
                    <CheckCircle className="w-4 h-4 text-emerald-500" />{t("Право на удаление и прекращение")}</h4>
              ...
              <div className="mt-4 pt-3 border-t border-red-100 text-xs text-slate-700 space-y-2">
                ...
                <p>
                  <strong>{t("Право на обжалование:")}</strong> Если Вы считаете, что обработка Ваших данных нарушает законодательство, Вы вправе обжаловать действия Оператора в уполномоченный орган по защите прав субъектов персональных данных – <strong>{t("Национальный центр защиты персональных данных Республики Беларусь (НЦЗПД)")}</strong>.
                </p>
              </div>
            </section>
            ...
            <section className="space-y-3">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-500 font-mono">6.</span>{t("Трансграничная передача и уполномоченные лица")}</h2>
              <p>{t("Трансграничная передача персональных данных пользователей на территорию иностранных государств не осуществляется без Вашего предварительного согласия.")}</p>
              <p>{t("Оператор вправе поручить обработку персональных данных")}<strong>{t("Уполномоченным лицам")}</strong> – государственным учреждениям здравоохранения (Региональным центрам трансфузиологии, РНПЦ трансфузиологии и медицинских биотехнологий) исключительно для ведения медицинского учета доноров, верификации отводов от донорства и планирования процедур забора крови.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-lg font-bold text-slate-950 flex items-center gap-2">
                <span className="text-red-500 font-mono">7.</span>{t("Заключительные положения")}</h2>
              <p>{t("Настоящая Политика вступает в силу с момента её публикации на Платформе. Оператор имеет право вносить изменения в настоящую Политику в одностороннем порядке. Новая редакция Политики вступает в силу с момента её размещения на Сайте, если иное не предусмотрено новой редакцией Политики.")}</p>
            </section>
          </>
        ) : (
          <>
            <section className="space-y-3">
              ...
              <p>
                Палітыка вызначае парадак апрацоўкі персанальных дадзеных карыстальнікаў платформы «Донар-Алерт» (далей – Платформа, Сайт) і меры па забеспячэнню бяспекі персанальных дадзеных, якія прымаюцца <strong>{t("Аператарам")}</strong>.
              </p>
              <p>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>{t("Аператар")}</strong> – дзяржаўны орган, юрыдычная асоба Рэспублікі Беларусь, фізічная асоба, у тым ліку індывідуальны прадпрымальнік, якія самастойна або сумесна з іншымі асобамі арганізуюць і (або) ажыццяўляюць апрацоўку персанальных дадзеных.</li>
                ...
                <li><strong>{t("Персанальныя дадзеныя")}</strong> – любая інфармацыя, якая адносіцца да ідэнтыфікаванай фізічнай асобы або фізічнай асобы, якая можа быць ідэнтыфікавана.</li>
              </ul>
            </section>
            ...
            <section className="space-y-3 bg-red-50/50 p-5 rounded-2xl border border-red-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 text-xs">
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center gap-1.5">
                    <CheckCircle className="w-4 h-4 text-emerald-500" />{t("Права на водгук згоды")}</h4>
                  <p className="text-slate-500">
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  ...
                  <p className="text-slate-500">
                    Вы маеце права запытаць звесткі аб апрацоўцы Вашых персанальных дадзеных і атрымаць іх на працягу <strong>5 рабочых дзён</strong>{t("бясплатна.")}</p>
                </div>

                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-xs space-y-2">
                  <h4 className="font-bold text-slate-900 flex items-center gap-1.5">
                    <CheckCircle className="w-4 h-4 text-emerald-500" />{t("Права на змяненне дадзеных")}</h4>
                  <p className="text-slate-500">
                    У выпадку недакладнасці або неактуальнасці дадзеных, Аператар абавязаны ўнесці змены на працягу <strong>15 каляндарных дзён</strong>{t("пасля атрымання патрабавання.")}</p>
                </div>
