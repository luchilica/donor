  ...
  for (const item of data.donors) {
    await prisma.donor.create({
      data: {
        ...
        plasmaDonationsCount: item.plasmaDonationsCount || 0,
        plateletsDonationsCount: item.plateletsDonationsCount || 0,
        bloodFreeCount: item.bloodFreeCount || 0,
        bloodPaidCount: item.bloodPaidCount || 0,
        compFreeCount: item.compFreeCount || 0,
        compPaidCount: item.compPaidCount || 0,
    ...
    try {
      ...
      return {
        ...
        donors: dbDonors.map(m => ({
          ...
          plasmaDonationsCount: m.plasmaDonationsCount,
          plateletsDonationsCount: m.plateletsDonationsCount,
          bloodFreeCount: m.bloodFreeCount,
          bloodPaidCount: m.bloodPaidCount,
          compFreeCount: m.compFreeCount,
          compPaidCount: m.compPaidCount,
